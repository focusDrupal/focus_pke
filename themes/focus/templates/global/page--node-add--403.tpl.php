  ...
  if ($is_front):
    ...
    <div class="row">
      ...
      <?php if ($title): ?>
        ...
        <h1 class="col-md-<?php print $cols['title']['md']; ?> col-sm-<?php print $cols['title']['sm']; ?> col-xs-<?php print $cols['title']['xs']; ?>" id="page-title">
          <?php if ($title_image): ?>
      ...
      <div id="content-wrapper" class="col-md-<?php print $cols['content_main']['md']; ?> col-sm-<?php print $cols['content_main']['sm']; ?> col-md-<?php print $cols['content_main']['xs']; ?>">
        ...
        <div class="row">
          <div class="col-md-<?php print $cols['content']['md']; ?> col-sm-<?php print $cols['content']['sm']; ?> col-xs-<?php print $cols['content']['xs']; ?>">
              ...
              <br />
              <p><?php print l(t('Log in'), 'http://focus/user/login_en'); ?>  to submit a <?php print $node_type_403; ?>.</p>
              
              <?php if ($logged_in): ?>
                <br />
                <p>If you are logged in, please complete your <?php print l(t('personal profile'), 'user'); ?> in order to acquire full privileges on the portal.</p>
              <?php endif; ?>
              <p>If you do not have an account yet, please <?php print l(t('register an account'), 'http://focus/user/register_en'); ?>, 
                or read more about how you can get involved in the FOCUS portal.</p>
              <br />
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            <ul id="services-bottom" class="reset-list">
              <?php if (!empty($eip_last_updated)): ?>
                <li><span><?php print $eip_last_updated; ?></span></li>
              <?php endif; ?>
              <li><a href="#top-page">Top</a></li>
              <?php if (!empty($eip_footer_menu)): ?>
                <?php print $eip_footer_menu; ?>
              <?php endif; ?>
            </ul>
          </div>
        </div>
